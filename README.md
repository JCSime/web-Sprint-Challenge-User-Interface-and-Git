...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    It the best way to intuitively label your html tags

2. Name two big differences between ```display: block;``` and ```display: inline;```.

    A block takes up all the space has white space above and below and inline only takes up the space it needs
...
5. Explain why git is valuable to a team of developers.
    It allows muiltiple people to have access to main code and the ability to add to it without breaking it.
